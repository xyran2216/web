(function ($) {
    ...
    let auto_refresh = setInterval(
        function () {
            $('#live_servers').load('ajax/servers').fadeIn("slow");
        }, 1000);
    auto_refresh = setInterval(
        function () {
            $('#online').load('ajax/online').fadeIn("slow");
        }, 1000);
    auto_refresh = setInterval(
        function () {
            $('#ticket').load('ajax/ticket').fadeIn("slow");
        }, 1000);
    ...
    function nbrCara(cara, nbrcara) {
        const nombre = document.getElementById(cara).value.length;
